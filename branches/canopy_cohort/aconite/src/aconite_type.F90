...
! !MODULE: aconite_type
      ...
      type,public :: state_type
         ...
         real,pointer :: Tave
          ...
          real, pointer :: soilC_1
          real, pointer :: soilC_2
          real, pointer :: soilC_3
          real, pointer :: soilC_4
          real, pointer :: soilN_1
          real, pointer :: soilN_2
      ...
      type,public :: flux_type
         ...
         real,pointer :: rootN_dist_litter
         real,pointer :: labileC_dist_atm
         real,pointer :: labileC_dist_litter	
         real,pointer :: labileC_bud_dist_atm
         real,pointer :: labileC_bud_dist_litter
         real,pointer :: labileC_Ra_dist_atm
         real,pointer :: labileC_Ra_dist_litter	
         real,pointer :: labileN_dist_atm
         real,pointer :: labileN_dist_litter	
         real,pointer :: labileN_bud_dist_atm
         real,pointer :: labileN_bud_dist_litter	
         real,pointer :: dist_litterC    		
		 real,pointer :: dist_litterN
		 real,pointer :: dist_cwdC
		 real,pointer :: dist_cwdN 
		 real,pointer :: dist_litterC_to_soil1
      	 real,pointer :: dist_litterC_to_soil2
      	 real,pointer :: dist_litterN_to_soil1
      	 real,pointer :: dist_litterN_to_soil2
      	 real,pointer :: nfert_nh4
      	 real,pointer :: nfert_no3
         ...
         real,pointer :: soil1_to_atm_C
         real,pointer :: soil2_to_atm_C
         real,pointer :: soil2_to_soil3_C
         real,pointer :: soil2_to_soil4_C
         real,pointer :: soil3_to_atm_C
         real,pointer :: soil4_to_atm_C
         real,pointer :: soil1_to_NH4
         real,pointer :: soil2_to_soil3_N
         real,pointer :: soil2_to_soil4_N
         real,pointer :: soil2_to_NH4
         real,pointer :: soil3_to_NH4
         real,pointer :: soil4_to_NH4
      ...
      type,public :: param_type
         ...
         real,pointer :: soil_model
         real,pointer :: aLF
         real,pointer :: bLF
         real,pointer :: flig
         real,pointer :: flig_min
         real,pointer :: rls_min
         real,pointer :: kLF
         real,pointer :: kLS
         real,pointer :: kSS
         real,pointer :: kSP
         ...
         real,pointer :: r_DOM
         real,pointer :: f_DOM
         real,pointer :: marg_ineff_exp
         real,pointer :: leafN_deficit_thres
         real,pointer :: damp_rate
      end type param_type
      ...
      type, public :: site_type
          ...
          real, pointer ::distyear(:) 
          real, pointer ::distintensity(:)
          real, pointer ::distremove(:)
          real, pointer :: distsoilloss(:)
          real, pointer :: nfertyear(:)
          real, pointer :: nfert_no3(:)
          real, pointer :: nfert_nh4(:)
          real, pointer :: soilwarmyear(:)
          real, pointer :: soilwarm_degree(:)     
      end type site_type
      ...
      type,public :: input_output_type
          ...
          character(len=200),pointer :: dist_in
          character(len=200),pointer :: nfert_in
          character(len=200),pointer :: soilwarm_in
          ...
          integer, pointer :: dist_length
          integer, pointer :: nfert_length
          integer, pointer :: soilwarm_length
          integer, pointer :: print_year_start
          integer, pointer :: print_year_end
          integer, pointer :: annual_state_doy
          integer, pointer :: sim_start_year
          integer, pointer :: cold_start
          integer, pointer :: spinup_length
          integer, pointer :: spinup_clim_length
